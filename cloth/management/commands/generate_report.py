...
from accessories.utils import get_recent_access_models
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        days = 1
        cloth_operations = get_recent_cloth_operations(days=days)
        access_models = get_recent_access_models(days=days)
        ...
        # Generate report
        generated = generate_production_report(cloth_operations, access_models, producion_models, packing_models, full_path)
        if generated:

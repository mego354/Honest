# Generated by Django 5.1.1 on 2025-02-19 10:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bag_length', models.CharField(blank=True, max_length=255, null=True, verbose_name='مقاس الكيس (الطول)')),
                ('bag_width', models.CharField(blank=True, max_length=255, null=True, verbose_name='مقاس الكيس (العرض)')),
                ('bags_per_kilo', models.IntegerField(blank=True, null=True, verbose_name='عدد الاكياس في الكيلو')),
                ('weight', models.IntegerField(blank=True, null=True, verbose_name='عدد الاكياس')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('length', models.CharField(blank=True, max_length=255, null=True, verbose_name='المقاس (الطول)')),
                ('width', models.CharField(blank=True, max_length=255, null=True, verbose_name='المقاس (العرض)')),
                ('height', models.CharField(blank=True, max_length=255, null=True, verbose_name='المقاس (الارتفاع)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(primary_key=True, serialize=False, verbose_name='الرمز')),
                ('width', models.CharField(blank=True, max_length=255, null=True, verbose_name='عرض اللزق')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('factory', models.CharField(blank=True, max_length=255, null=True, verbose_name='المصنع')),
                ('id', models.IntegerField(primary_key=True, serialize=False, verbose_name='الرمز')),
                ('width', models.CharField(blank=True, max_length=255, null=True, verbose_name='عرض الاستك')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model_number', models.CharField(blank=True, max_length=255, null=True, verbose_name='رقم الموديل')),
                ('size', models.CharField(blank=True, max_length=255, null=True, verbose_name='المقاس')),
                ('cotton_percentage', models.CharField(blank=True, max_length=255, null=True, verbose_name='نسبة القطن')),
                ('polyester_percentage', models.CharField(blank=True, max_length=255, null=True, verbose_name='نسبة البوليستر')),
